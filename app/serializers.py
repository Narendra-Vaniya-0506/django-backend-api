...
from django.core.validators import EmailValidator
import re
from .models import UserProfile, UserLessonProgress, LessonSession
...
class UserProfileDetailSerializer(serializers.ModelSerializer):
    ...
    lessons_started = serializers.SerializerMethodField()
    ...
    def get_lessons_started(self, obj):
        # Count of lessons started by the user
        user = obj.user
        started_count = LessonSession.objects.filter(user=user).count()
        return started_count

    def get_lessons_completed(self, obj):
        # Count of lessons completed by the user
        user = obj.user
        completed_count = UserLessonProgress.objects.filter(user=user, completed=True).count()
